    ...
    <div class="crud-container">
        ...
        <div class="universal-div">
            <div class="universal-div-main">
                <h3 class="universal-div-header">Edit Membership Plan</h3>
                <div>
                    @if(session()->has('success'))
                        <div>
                            {{session('success')}}
                ...
                <div class="universal-div-content">
                    <form method="post" action="{{ route('rate.update', ['rate' => $rate]) }}">
                        ...
                        <div class="label">
                            ...
                            <input type="text" name="name" id="name" value="{{$rate->name}}" required autofocus>
                        </div>
                        <div class="label">
                        ...
                        <div class="label">
                            ...
                            <input type="text" name="price" id="price" value="{{$rate->price}}" required>
                        </div>
                        <div class="label">
                            <label for="description">Description:</label>
                            <textarea name="description" id="description" rows="3" value="{{$rate->description}}"></textarea>
                        </div>
                        <div class="label">
                            <label for="perks">Perks:</label>
                            <textarea name="perks" id="perks" rows="3" value="{{$rate->perks}}"></textarea>
                        </div>
