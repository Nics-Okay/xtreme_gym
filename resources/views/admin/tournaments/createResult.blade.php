        ...
        <div class="page-content">
            <div class="crud-container">
                <div class="crud-content">
                    <h3 class="crud-header">Add Tournament Result</h3>
                    <div class="crud-form">
                        <form method="post" action="{{ route('result.store') }}">
                            ...
                            <div class="form-full">
                                <div class="form-content">
                                    ...
                                    <select name="tournament_id" id="tournament_id" required>
                                        <option value="" disabled {{ old('tournament_id') ? '' : 'selected' }}>- Select Tournament -</option>
                            ...
                            <div class="form-group">
                                <div class="form-content">
                                    ...
                                    <input type="text" id="remarks" name="remarks" value="{{ old('remarks') }}"  placeholder="Ex. Game 1, Semi-Finals" maxlength="255" required>
                                </div>
                                <div class="form-content">
                                    <label for="game_date">Game Date</label>
                                    <input type="date" id="game_date" name="game_date" value="{{ old('game_date') }}"  onclick="this.showPicker()" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-content">
                                    ...
                                    <select name="winner_name" id="winner_name" required>
                                        <option value="" disabled {{ old('winner_name') ? '' : 'selected' }}>- Select Winner -</option>
                                        @foreach ($participants as $participant)
                                            <option value="{{ $participant->participant_name }}" {{ old('winner_name') == $participant->participant_name ? 'selected' : '' }}>
                                ...
                                <div class="form-content">
                                    ...
                                    <input type="number" id="winner_score" name="winner_score" placeholder="Enter Winner Score" value="{{ old('winner_score') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-content">
                                    ...
                                    <select name="defeated_name" id="defeated_name" required>
                                        <option value="" disabled {{ old('defeated_name') ? '' : 'selected' }}>- Select Defeated -</option>
                                        @foreach ($participants as $participant)
                                            <option value="{{ $participant->participant_name }}" {{ old('defeated_name') == $participant->participant_name ? 'selected' : '' }}>
                                                {{ $participant->participant_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-content">
                                    ...
                                    <input type="number" id="defeated_score" name="defeated_score" placeholder="Defeated Participant Score" value="{{ old('defeated_score') }}" required>
                                </div>
                            </div>
